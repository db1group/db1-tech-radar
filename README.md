# DB1 Technology Radar

A static site generator for DB1 Technology Radar

## Looking for the DB1 Tech Radar content?

The repository is now found here: https://github.com/AOEpeople/techradar

The DB1 Tech radar is deployed here: https://www.aoe.com/techradar/index.html
...
- Also, when you want to reuse the CSS and Styling: Change the font (it is a licensed font) and the colors (It using DB1 CI)
...
Set the environment variable `REACT_APP_RADAR_NAME`. The default is "DB1 Technology Radar".
...
To change the logo, create a folder named `public` and put your `logo/db1-logo.png` in it.

For reference have a look at [public/logo/db1-logo.png](./public/logo/db1-logo.png).
...
```json
{
  "footerFootnote": "DB1 is a leading global provider of services for digital transformation and digital business models. DB1 relies exclusively on established Enterprise Open Source technologies. This leads to innovative solutions, digital products and portals in agile software projects, and helps build long-lasting, strategic partnerships with our customers."
}
```
  ...
  "pageHelp": {
    "paragraphs": [
      {
        ...
        "values": [
          ...
          "It's essential for a development and technology company such as DB1 to constantly improve and keep track with the latest useful innovations. It is important to openly look for innovations and new technologies and to question established technologies and methods every now and then.",
      ...
      {
        "headline": "What is the DB1 Technology Radar",
        "values": [
    ...
    "quadrants": [
      ...
      },
      {
        ...
        "description": "(including DB1 internal Services): Here we include infrastructure platforms and services. We also use this category to communicate news about DB1 services that we want all DB1 teams to be aware of."
      }
    ],
    "rings": [
      {
    ...
    "sourcecodeLink": {
      ...
      "name": "DB1 Tech Radar on Github",
      "description": "Contributions and source code of the DB1 Tech Radar are on github:"
    }
  }
}
```
